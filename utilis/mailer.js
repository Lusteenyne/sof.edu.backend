...
const sendSuperAdminMail = (email, fullName) => {
  return sendEmail(
    ...
    `<h2>Welcome, ${fullName}</h2>
     ...
     <a href="https://sof-edu.onrender.com/login-superadmin" style="display:inline-block; margin-top:20px; padding:10px 20px; background:#1a73e8; color:white; text-decoration:none; border-radius:5px;">Access Admin Panel</a>
...
const sendTeacherApprovalEmail = (email, title, fullName, teacherId) => {
  return sendEmail(
    ...
    `<h2>Your Account Has Been Approved</h2>
     ...
     <a href="https://sof-edu.onrender.com/login-teacher" style="display:inline-block; margin-top:20px; padding:10px 20px; background:#28a745; color:white; text-decoration:none; border-radius:5px;">Login to Portal</a>`
  );
};
...
const sendCourseRegistrationMail = (fullName, semester, department, level) => {
  return sendEmail(
    ...
    `<h2>New Course Registration Submitted</h2>
     ...
     <a href="https://sof-edu.onrender.com/login-superadmin" style="display:inline-block; margin-top:20px; padding:10px 20px; background:#1a73e8; color:white; text-decoration:none; border-radius:5px;">
...
const sendTuitionPaymentToAdmin = (fullName, amount, method, department, session) => {
  return sendEmail(
    ...
    `<h2>Tuition Payment Received</h2>
     ...
     <p><a href="https://sof-edu.onrender.com/login-superadmin">Verify in Admin Portal</a></p>`
  );
};
...
const sendNewAssignmentEmail = (studentEmail, studentName, courseTitle, courseCode, assignmentTitle, deadline) => {
  return sendEmail(
    ...
    `<h2>New Assignment Alert</h2>
     ...
     <a href="https://sof-edu.onrender.com/login-student" 
...
const sendAssignmentSubmissionEmail = (teacherEmail, teacherName, studentName, assignmentTitle) => {
  return sendEmail(
    ...
    `<h2>New Assignment Submission</h2>
     ...
     <a href="https://sof-edu.onrender.com/login-teacher"
        style="display:inline-block; margin-top:20px; padding:10px 20px; background:#1a73e8; color:white; text-decoration:none; border-radius:5px;">
        Review Submission
     </a>
...
const sendTeacherMessageNotificationToAdmin = (teacherFullName, messagePreview) => {
  return sendEmail(
    ...
    `<h2>New Message from Teacher</h2>
     ...
     <a href="https://sof-edu.onrender.com/login-superadmin" 
        style="display:inline-block; margin-top:20px; padding:10px 20px; background:#1a73e8; color:white; text-decoration:none; border-radius:5px;">
